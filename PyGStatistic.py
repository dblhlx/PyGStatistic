    ...
    for chrmID in chrmIDL:
        ...
        if len(chrmIDL) == 1:
            ...
            if i==1:
                axs[0].set_ylabel('Number of SNPs')
                # axs[1].set_ylabel(r'ltaSNP/totalSNP')
                axs[1].set_ylabel('G-statistic')
                # axs[3].set_ylabel('\u0394(SNP index)')
        ...
        # Handle the plot with multiple columns (chromosomes)
            ...
            # G-statistic plot
            axs[1,i-1].plot(x, y5, c='k')
            axs[1,i-1].plot(x, y6, c='r')
            ...
            if i==1:
                axs[0,i-1].set_ylabel('Number of SNPs')
                # axs[1,i-1].set_ylabel(r'ltaSNP/totalSNP')
                axs[1,i-1].set_ylabel('G-statistic')
                # axs[3,i-1].set_ylabel('\u0394(SNP index)')
